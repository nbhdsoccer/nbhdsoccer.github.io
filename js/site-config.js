...
const SITE_CONFIG = {
  events: [
    ...
    },
    {
      ...
      buttonLink: "/community-soccer/pickup.html", // ✅ ROOT-RELATIVE PATH
    ...
    },
    {
      ...
      buttonLink: "/youth-programs/rec77.html", // ✅ ROOT-RELATIVE PATH
      showInFeatured: false // Don't show in featured - it's in youth programming section
    },
    {
      id: "cps-alumni-game",
    ...
    },
    {
      ...
      buttonLink: "/community-soccer/womens.html" // ✅ ROOT-RELATIVE PATH
    },
  ],
